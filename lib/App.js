...
var App = /** @class */ (function () {
    ...
    App.prototype.createStore = function () {
        return redux_1.createStore(this.reducer.bind(this), this.initialState());
    };
    /**
     * 启动应用
     ...
     * @returns {StateInterface}
     */
    App.prototype.reducer = function (state, action) {
        if (state === void 0) { state = {}; }
        var newState = Object.assign({}, state);
        for (var name_2 in this._models)
            state[name_2] = this._models[name_2].getInitState();
        return newState;
    };
    /**
     * 触发效果处理
